...
const styles = {
  ...
  indicatorSpan: cva('absolute left-2 flex h-3.5 w-3.5 items-center justify-center'),
  radioItem: cva(
    'focus:bg-accent focus:text-accent-foreground relative flex cursor-default items-center rounded-sm py-1.5 pr-2 pl-8 text-sm transition-colors outline-none select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50'
  ),
...
>(({ className, inset, children, ...props }, ref) => (
  ...
  >
    {children}
    <Icon icon={ChevronRight} size="sm" tone="submenuTrailing" />
  </DropdownMenuPrimitive.SubTrigger>
))
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    <span className={styles.indicatorSpan()}>
      <DropdownMenuPrimitive.ItemIndicator>
        <Icon icon={Circle} size="xs" tone="radioIndicator" />
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </DropdownMenuPrimitive.RadioItem>
